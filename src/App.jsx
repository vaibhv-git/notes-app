...
const App = () => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("notes", JSON.stringify(pass));
    ...
    <div>
      ...
      <div className="p-7 float-animation">
        ...
        <h3 className="p-3 text-center text-s capitalize text-white love-ya-like-a-sister-regular">
          you can create or delete your notes !!
        </h3>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="lg:border-1-2 lg:w-1/2 p-10">
            ...
            <div className="flex flex-wrap gap-5 mt-5 overflow-y-auto scrollbar-hide max-h-700px">
